 ...
 * @author Arif Zaman
 */
public class Sp_Result extends javax.swing.JFrame {
    static int result;

    /**
     * Creates new form Sp_Result
     */
    public Sp_Result() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        result = Sp_Q1.points + Sp_Q2.points + Sp_Q3.points + Sp_Q4.points + Sp_Q5.points;
        ...
        if(result>=45){
            this.jLabel9.setText("Your Performence is  !!! Excellent !!!");
        }
        else if(result>=35 && result<=44){
            this.jLabel9.setText("Your Performence is  !! Good !!");
        }
        else if(result>=16 && result<=34){
            this.jLabel9.setText("Your Performence is  ! Average !");
        }
        else {
            this.jLabel9.setText("Your Performence is  Poor");
        }
        
        if (Sp_Q1.points == 10){
            this.jLabel3.setText("1. Right Answer ! ");
        }else if (Sp_Q1.points == -5){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sp_Result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
