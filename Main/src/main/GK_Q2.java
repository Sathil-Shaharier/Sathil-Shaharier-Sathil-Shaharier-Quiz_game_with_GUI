 ...
 * @author Arif Zaman
 */
public class GK_Q2 extends javax.swing.JFrame {
    static int points ; 

    /**
     * Creates new form GK_Q2
     */
    public GK_Q2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("2.  Which ocean separates the USA and Europe?");

        jButton1.setText("Arctic");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GK_Q2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
