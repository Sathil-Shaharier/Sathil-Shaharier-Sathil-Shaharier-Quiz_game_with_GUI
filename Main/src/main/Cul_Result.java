 ...
 * @author Arif Zaman
 */
public class Cul_Result extends javax.swing.JFrame {
    static int result;

    /**
     * Creates new form Cul_Result
     */
    public Cul_Result() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        result = Cul_Q1.points + Cul_Q2.points + Cul_Q3.points + Cul_Q4.points + Cul_Q5.points;
        this.jLabel10.setText("Your result : ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cul_Result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cul_Result().setVisible(true);
            }
        });
    }
